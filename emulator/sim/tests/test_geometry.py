...
def test_flat_overlay_recomputes_stride(tmp_path):
    ...
    fmt = load_frame_format(str(cfg_file), "S50")
    assert fmt.width == 3856
    assert fmt.stride_bytes == 3856 * 2, "stride_bytes must be recomputed from flat overlay width"
